          ...
          <div className={classes.inner}>
            ...
            <ul className={classes.list}>
              <li className={classes.listItem}>
                ...
                <h5 className={classes.label}>Для людей с маленьким и большим капиталом</h5>
              </li>
              <li className={classes.listItem}>
                <div className={classes.mark}>
                  <PlusMark />
                </div>
                <h5 className={classes.label}>У кого мало времени для ежедневной торговли</h5>
              </li>
              <li className={classes.listItem}>
                <div className={classes.mark}>
                  <PlusMark />
              ...
              <li className={classes.listItem}>
                ...
                <h5 className={classes.label}>Кто не хочет глубоко изучать технический анализ</h5>
              </li>
              <li className={classes.listItem}>
                <div className={classes.mark}>
                  <PlusMark />
                </div>
                <h5 className={classes.label}>Кто хочет иметь доходность от 30% годовых</h5>
              </li>
            </ul>
          </div>
        </Col>
          ...
          <div className={cx(classes.inner, classes.marginTopMobile)}>
            ...
            <ul className={classes.list}>
              <li className={classes.listItem}>
                ...
                <h5 className={classes.label}>8 блоков видеоуроков</h5>
              </li>
              <li className={classes.listItem}>
                <div className={classes.mark}>
                  <StarMark />
                </div>
                <h5 className={classes.label}>Все уроки доступны в записи 8 недель</h5>
              </li>
              <li className={classes.listItem}>
                <div className={classes.mark}>
                  <StarMark />
              ...
              <li className={classes.listItem}>
                ...
                <h5 className={classes.label}>Ограниченная по времени связь с кураторами </h5>
              </li>
              <li className={classes.listItem}>
                <div className={classes.mark}>
                  <StarMark />
                </div>
                <h5 className={classes.label}>Базовое понимание рынка и риск-менеджмента </h5>
              </li>
            </ul>
          </div>
        </Col>
